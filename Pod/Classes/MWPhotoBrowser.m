...
- (void)configurePage:(MWZoomingScrollView *)page forIndex:(NSUInteger)index {
    ...
    page.photoImageView.backgroundColor = _backgroundColor;
    page.tapView.backgroundColor = _backgroundColor;
    self.backgroundColor = _backgroundColor;
    self.pagingScrollView.backgroundColor = _backgroundColor;
